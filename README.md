...
iDNA_GAT predicts 6mA sites from 41-bp DNA sequences. It combines sequence and graph views and uses gradient affinity to select auxiliary tasks for cross-task learning.
